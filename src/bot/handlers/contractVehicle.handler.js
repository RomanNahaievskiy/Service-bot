...
//   const vehicles = Array.isArray(session.data.contractVehicles)
...
//   if (!v) {
//     session.data.contractVehicleError = `ТЗ з номером "${rawInput}" не знайдено за договором ${session.data.contractNo}.`;
...
//   session.data.vehicleTitle = v.vehicleTitle || getVehicleNumber(v) || rawInput;
